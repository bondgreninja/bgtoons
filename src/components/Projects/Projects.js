        ...
        <Row style={{ justifyContent: "center", paddingBottom: "10px" }}>
          <Col md={4} className="project-card">
            <ProjectCard
              ...
              link="https://github.com/skgupta507/taskify"
          ...
          <Col md={4} className="project-card">
            <ProjectCard
              ...
              link="https://github.com/skgupta507/easy-code"
              liveLink="https://instagram.com/sk.gupta507/"
            />
          </Col>
          ...
          <Col md={4} className="project-card">
            <ProjectCard
              ...
              link="https://github.com/skgupta507/e-commerce-store"
          ...
          <Col md={4} className="project-card">
            <ProjectCard
              ...
              link="https://github.com/skgupta507/react-blog-website"
          ...
          <Col md={4} className="project-card">
            <ProjectCard
              ...
              link="https://github.com/skgupta507/Artistee"
